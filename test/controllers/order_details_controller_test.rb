...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, api_order_id: @order_detail.api_order_id, link: @order_detail.link, order_row_id: @order_detail.order_row_id, status: @order_detail.status } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, api_order_id: @order_detail.api_order_id, link: @order_detail.link, order_row_id: @order_detail.order_row_id, status: @order_detail.status } }
